...
class RolesMappingArgs:
    def __init__(__self__, *,
                 ...
                 and_backend_roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 roles_mapping_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] role_name: The name of the security role.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] and_backend_roles: A list of backend roles.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] backend_roles: A list of backend roles.
        :param pulumi.Input[builtins.str] description: Description of the role mapping.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] hosts: A list of host names.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] users: A list of users.
        """
        ...
        if roles_mapping_id is not None:
            pulumi.set(__self__, "roles_mapping_id", roles_mapping_id)
    ...
    def and_backend_roles(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def and_backend_roles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    @property
    @pulumi.getter(name="rolesMappingId")
    def roles_mapping_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "roles_mapping_id")

    @roles_mapping_id.setter
    def roles_mapping_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "roles_mapping_id", value)
...
@pulumi.type_token("opensearch:index/rolesMapping:RolesMapping")
class RolesMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RolesMapping resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["roles_mapping_id"] = roles_mapping_id
    ...
    def get(resource_name: str,
            ...
            role_name: Optional[pulumi.Input[builtins.str]] = None,
            roles_mapping_id: Optional[pulumi.Input[builtins.str]] = None,
            users: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'RolesMapping':
        """
    ...
    @property
    @pulumi.getter(name="andBackendRoles")
    def and_backend_roles(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of backend roles.
        """
        return pulumi.get(self, "and_backend_roles")
    ...
    @property
    @pulumi.getter(name="rolesMappingId")
    def roles_mapping_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "roles_mapping_id")
