...
class IngestPipelineArgs:
    def __init__(__self__, *,
                 ...
                 ingest_pipeline_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a IngestPipeline resource.
        :param pulumi.Input[builtins.str] body: The JSON body of the ingest pipeline
        :param pulumi.Input[builtins.str] name: The name of the ingest pipeline
        """
        pulumi.set(__self__, "body", body)
        if ingest_pipeline_id is not None:
            pulumi.set(__self__, "ingest_pipeline_id", ingest_pipeline_id)
        if name is not None:
    ...
    @property
    @pulumi.getter(name="ingestPipelineId")
    def ingest_pipeline_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "ingest_pipeline_id")

    @ingest_pipeline_id.setter
    def ingest_pipeline_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ingest_pipeline_id", value)
...
@pulumi.type_token("opensearch:index/ingestPipeline:IngestPipeline")
class IngestPipeline(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a IngestPipeline resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["ingest_pipeline_id"] = ingest_pipeline_id
    ...
    def get(resource_name: str,
            ...
            body: Optional[pulumi.Input[builtins.str]] = None,
            ingest_pipeline_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'IngestPipeline':
        """
    ...
    @property
    @pulumi.getter(name="ingestPipelineId")
    def ingest_pipeline_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "ingest_pipeline_id")
