...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 aws_assume_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 aws_assume_role_external_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 aws_signature_service: Optional[pulumi.Input[builtins.str]] = None,
                 aws_token: Optional[pulumi.Input[builtins.str]] = None,
                 cacert_file: Optional[pulumi.Input[builtins.str]] = None,
                 client_cert_path: Optional[pulumi.Input[builtins.str]] = None,
                 client_key_path: Optional[pulumi.Input[builtins.str]] = None,
                 healthcheck: Optional[pulumi.Input[builtins.bool]] = None,
                 host_override: Optional[pulumi.Input[builtins.str]] = None,
                 insecure: Optional[pulumi.Input[builtins.bool]] = None,
                 opensearch_version: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 proxy: Optional[pulumi.Input[builtins.str]] = None,
                 sign_aws_requests: Optional[pulumi.Input[builtins.bool]] = None,
                 sniff: Optional[pulumi.Input[builtins.bool]] = None,
                 token: Optional[pulumi.Input[builtins.str]] = None,
                 token_name: Optional[pulumi.Input[builtins.str]] = None,
                 username: Optional[pulumi.Input[builtins.str]] = None,
                 version_ping_timeout: Optional[pulumi.Input[builtins.float]] = None):
        """
        The set of arguments for constructing a Provider resource.
        :param pulumi.Input[builtins.str] url: OpenSearch URL
        :param pulumi.Input[builtins.str] aws_access_key: The access key for use with AWS OpenSearch Service domains
        :param pulumi.Input[builtins.str] aws_assume_role_arn: Amazon Resource Name of an IAM Role to assume prior to making AWS API calls.
        :param pulumi.Input[builtins.str] aws_assume_role_external_id: External ID configured in the IAM policy of the IAM Role to assume prior to making AWS API calls.
        :param pulumi.Input[builtins.str] aws_profile: The AWS profile for use with AWS OpenSearch Service domains
        :param pulumi.Input[builtins.str] aws_region: The AWS region for use in signing of AWS OpenSearch requests. Must be specified in order to use AWS URL signing with AWS
               OpenSearch endpoint exposed on a custom DNS domain.
        :param pulumi.Input[builtins.str] aws_secret_key: The secret key for use with AWS OpenSearch Service domains
        :param pulumi.Input[builtins.str] aws_signature_service: AWS service name used in the credential scope of signed requests to OpenSearch.
        :param pulumi.Input[builtins.str] aws_token: The session token for use with AWS OpenSearch Service domains
        :param pulumi.Input[builtins.str] cacert_file: A Custom CA certificate
        :param pulumi.Input[builtins.str] client_cert_path: A X509 certificate to connect to OpenSearch
        :param pulumi.Input[builtins.str] client_key_path: A X509 key to connect to OpenSearch
        :param pulumi.Input[builtins.bool] healthcheck: Set the client healthcheck option for the OpenSearch client. Healthchecking is designed for direct access to the
               cluster.
        :param pulumi.Input[builtins.str] host_override: If provided, sets the 'Host' header of requests and the 'ServerName' for certificate validation to this value. See the
               documentation on connecting to OpenSearch via an SSH tunnel.
        :param pulumi.Input[builtins.bool] insecure: Disable SSL verification of API calls
        :param pulumi.Input[builtins.str] opensearch_version: OpenSearch Version
        :param pulumi.Input[builtins.str] password: Password to use to connect to OpenSearch using basic auth
        :param pulumi.Input[builtins.str] proxy: Proxy URL to use for requests to OpenSearch.
        :param pulumi.Input[builtins.bool] sign_aws_requests: Enable signing of AWS OpenSearch requests. The `url` must refer to AWS ES domain (`*.<region>.es.amazonaws.com`), or
               `aws_region` must be specified explicitly.
        :param pulumi.Input[builtins.bool] sniff: Set the node sniffing option for the OpenSearch client. Client won't work with sniffing if nodes are not routable.
        :param pulumi.Input[builtins.str] token: A bearer token or ApiKey for an Authorization header, e.g. Active Directory API key.
        :param pulumi.Input[builtins.str] token_name: The type of token, usually ApiKey or Bearer
        :param pulumi.Input[builtins.str] username: Username to use to connect to OpenSearch using basic auth
        :param pulumi.Input[builtins.float] version_ping_timeout: Version ping timeout in seconds
        """
    ...
    def aws_assume_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def aws_assume_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aws_assume_role_arn", value)

    @property
    @pulumi.getter(name="awsAssumeRoleExternalId")
    def aws_assume_role_external_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def aws_assume_role_external_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def aws_signature_service(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def aws_signature_service(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aws_signature_service", value)

    @property
    @pulumi.getter(name="awsToken")
    def aws_token(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @aws_token.setter
    def aws_token(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def client_cert_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_cert_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "client_cert_path", value)

    @property
    @pulumi.getter(name="clientKeyPath")
    def client_key_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_key_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "client_key_path", value)

    @property
    @pulumi.getter
    def healthcheck(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @healthcheck.setter
    def healthcheck(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "healthcheck", value)

    @property
    @pulumi.getter(name="hostOverride")
    def host_override(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def host_override(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def opensearch_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        OpenSearch Version
        """
    ...
    def opensearch_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sign_aws_requests(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def sign_aws_requests(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "sign_aws_requests", value)

    @property
    @pulumi.getter
    def sniff(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @sniff.setter
    def sniff(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def version_ping_timeout(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def version_ping_timeout(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "version_ping_timeout", value)


@pulumi.type_token("pulumi:providers:opensearch")
class Provider(pulumi.ProviderResource):
    ...
    @property
    @pulumi.getter(name="awsAssumeRoleArn")
    def aws_assume_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Amazon Resource Name of an IAM Role to assume prior to making AWS API calls.
        """
        return pulumi.get(self, "aws_assume_role_arn")
    ...
    @property
    @pulumi.getter(name="awsAssumeRoleExternalId")
    def aws_assume_role_external_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        External ID configured in the IAM policy of the IAM Role to assume prior to making AWS API calls.
        """
        return pulumi.get(self, "aws_assume_role_external_id")
    ...
    @property
    @pulumi.getter(name="awsProfile")
    def aws_profile(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The AWS profile for use with AWS OpenSearch Service domains
        """
        return pulumi.get(self, "aws_profile")
    ...
    @property
    @pulumi.getter(name="awsSignatureService")
    def aws_signature_service(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        AWS service name used in the credential scope of signed requests to OpenSearch.
        """
        return pulumi.get(self, "aws_signature_service")
    ...
    @property
    @pulumi.getter(name="awsToken")
    def aws_token(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The session token for use with AWS OpenSearch Service domains
        """
        return pulumi.get(self, "aws_token")
    ...
    @property
    @pulumi.getter(name="clientCertPath")
    def client_cert_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A X509 certificate to connect to OpenSearch
        """
        return pulumi.get(self, "client_cert_path")
    ...
    @property
    @pulumi.getter(name="clientKeyPath")
    def client_key_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A X509 key to connect to OpenSearch
        """
        return pulumi.get(self, "client_key_path")
    ...
    @property
    @pulumi.getter(name="hostOverride")
    def host_override(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If provided, sets the 'Host' header of requests and the 'ServerName' for certificate validation to this value. See the
        documentation on connecting to OpenSearch via an SSH tunnel.
        """
    ...
    @property
    @pulumi.getter(name="opensearchVersion")
    def opensearch_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        OpenSearch Version
        """
        return pulumi.get(self, "opensearch_version")
