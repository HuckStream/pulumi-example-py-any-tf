...
class ComponentTemplateArgs:
    def __init__(__self__, *,
                 ...
                 component_template_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ComponentTemplate resource.
        :param pulumi.Input[builtins.str] body: The JSON body of the template.
        :param pulumi.Input[builtins.str] name: Name of the component template to create.
        """
        pulumi.set(__self__, "body", body)
        if component_template_id is not None:
            pulumi.set(__self__, "component_template_id", component_template_id)
        if name is not None:
    ...
    @property
    @pulumi.getter(name="componentTemplateId")
    def component_template_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "component_template_id")

    @component_template_id.setter
    def component_template_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "component_template_id", value)
...
@pulumi.type_token("opensearch:index/componentTemplate:ComponentTemplate")
class ComponentTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ComponentTemplate resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["component_template_id"] = component_template_id
    ...
    def get(resource_name: str,
            ...
            body: Optional[pulumi.Input[builtins.str]] = None,
            component_template_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'ComponentTemplate':
        """
    ...
    @property
    @pulumi.getter(name="componentTemplateId")
    def component_template_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "component_template_id")
