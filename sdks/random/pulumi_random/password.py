...
class _PasswordState:
    def __init__(__self__, *,
                 bcrypt_hash: Optional[pulumi.Input[builtins.str]] = None,
                 keepers: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] bcrypt_hash: A bcrypt hash of the generated random string. **NOTE**: If the generated random string is greater than 72 bytes in
    ...
    def bcrypt_hash(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @bcrypt_hash.setter
    def bcrypt_hash(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Password(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            result: Optional[pulumi.Input[builtins.str]] = None,
            special: Optional[pulumi.Input[builtins.bool]] = None,
            upper: Optional[pulumi.Input[builtins.bool]] = None) -> 'Password':
        """
    ...
    @property
    @pulumi.getter(name="bcryptHash")
    def bcrypt_hash(self) -> pulumi.Output[builtins.str]:
        """
        A bcrypt hash of the generated random string. **NOTE**: If the generated random string is greater than 72 bytes in
        length, `bcrypt_hash` will contain a hash of the first 72 bytes.
        """
