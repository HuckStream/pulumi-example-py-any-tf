...
class PetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. See the main provider documentation for
               more information.
        :param pulumi.Input[builtins.float] length: The length (in words) of the pet name. Defaults to 2
        :param pulumi.Input[builtins.str] prefix: A string to prefix the name with.
        :param pulumi.Input[builtins.str] separator: The character to separate words in the pet name. Defaults to "-"
        """
...
class Pet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            length: Optional[pulumi.Input[builtins.float]] = None,
            prefix: Optional[pulumi.Input[builtins.str]] = None,
            separator: Optional[pulumi.Input[builtins.str]] = None) -> 'Pet':
        """
    ...
    @property
    @pulumi.getter
    def separator(self) -> pulumi.Output[builtins.str]:
        """
        The character to separate words in the pet name. Defaults to "-"
        """
        return pulumi.get(self, "separator")
