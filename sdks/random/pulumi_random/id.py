...
class IdArgs:
    def __init__(__self__, *,
                 byte_length: pulumi.Input[builtins.float],
        ...
        :param pulumi.Input[builtins.float] byte_length: The number of random bytes to produce. The minimum value is 1, which produces eight bits of randomness.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. See the main provider documentation for
               more information.
        :param pulumi.Input[builtins.str] prefix: Arbitrary string to prefix the output value with. This string is supplied as-is, meaning it is not guaranteed to be
    ...
    def byte_length(self) -> pulumi.Input[builtins.float]:
        """
    ...
    @byte_length.setter
    def byte_length(self, value: pulumi.Input[builtins.float]):
...
class _IdState:
    def __init__(__self__, *,
                 b64_std: Optional[pulumi.Input[builtins.str]] = None,
                 b64_url: Optional[pulumi.Input[builtins.str]] = None,
                 byte_length: Optional[pulumi.Input[builtins.float]] = None,
                 dec: Optional[pulumi.Input[builtins.str]] = None,
                 hex: Optional[pulumi.Input[builtins.str]] = None,
                 keepers: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 prefix: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Id resources.
        :param pulumi.Input[builtins.str] b64_std: The generated id presented in base64 without additional transformations.
        :param pulumi.Input[builtins.str] b64_url: The generated id presented in base64, using the URL-friendly character set: case-sensitive letters, digits and the
               characters `_` and `-`.
        :param pulumi.Input[builtins.float] byte_length: The number of random bytes to produce. The minimum value is 1, which produces eight bits of randomness.
        :param pulumi.Input[builtins.str] dec: The generated id presented in non-padded decimal digits.
        :param pulumi.Input[builtins.str] hex: The generated id presented in padded hexadecimal digits. This result will always be twice as long as the requested byte
               length.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] keepers: Arbitrary map of values that, when changed, will trigger recreation of resource. See the main provider documentation for
               more information.
        :param pulumi.Input[builtins.str] prefix: Arbitrary string to prefix the output value with. This string is supplied as-is, meaning it is not guaranteed to be
    ...
    def b64_std(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @b64_std.setter
    def b64_std(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "b64_std", value)

    @property
    @pulumi.getter(name="b64Url")
    def b64_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @b64_url.setter
    def b64_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "b64_url", value)

    @property
    @pulumi.getter(name="byteLength")
    def byte_length(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The number of random bytes to produce. The minimum value is 1, which produces eight bits of randomness.
        """
        return pulumi.get(self, "byte_length")
    ...
    @byte_length.setter
    def byte_length(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "byte_length", value)

    @property
    @pulumi.getter
    def dec(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @dec.setter
    def dec(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Id(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            hex: Optional[pulumi.Input[builtins.str]] = None,
            keepers: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            prefix: Optional[pulumi.Input[builtins.str]] = None) -> 'Id':
        """
    ...
    @property
    @pulumi.getter(name="b64Std")
    def b64_std(self) -> pulumi.Output[builtins.str]:
        """
        The generated id presented in base64 without additional transformations.
        """
        return pulumi.get(self, "b64_std")
    ...
    @property
    @pulumi.getter(name="b64Url")
    def b64_url(self) -> pulumi.Output[builtins.str]:
        """
        The generated id presented in base64, using the URL-friendly character set: case-sensitive letters, digits and the
        characters `_` and `-`.
        """
    ...
    @property
    @pulumi.getter(name="byteLength")
    def byte_length(self) -> pulumi.Output[builtins.float]:
        """
        The number of random bytes to produce. The minimum value is 1, which produces eight bits of randomness.
        """
        return pulumi.get(self, "byte_length")
    ...
    @property
    @pulumi.getter
    def dec(self) -> pulumi.Output[builtins.str]:
        """
        The generated id presented in non-padded decimal digits.
        """
        return pulumi.get(self, "dec")
